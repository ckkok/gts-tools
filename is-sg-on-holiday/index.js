const { fetchData, getActualHolidays } = require('./datasources');
...
const isPublicHoliday = async dateStr => {
  ...
  const actualHolidays = getActualHolidays(year, data);
  ...
  return { isHoliday, day: isHoliday ? holiday.day : '', reason: isHoliday ? holiday.holiday : '' };
}
